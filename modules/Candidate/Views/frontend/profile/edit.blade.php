                            ...
                            <div class="widget-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>{{ __('Contact Number ') }} <span class="text-danger" id="phone_error"></span></label>
                                                <input type="tel" value="{{ old('phone', $row->getAuthor?->phone) }}"
                                                    placeholder="{{ __('Contact Number') }}" id="phone" name="phone"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="country" class="form-control" id="country-sms-testing">
                                                    ...
                                                    @foreach (get_country_lists() as $id => $name)
                                                        <option @if (old('country',@$user->candidate->country) == $id) selected @endif
                                                        ...
                                                        <div class="form-content">
                                                            ...
                                                            <div class="smart-search">
                                                                ...
                                                                <input type="hidden" class="child_id" name="location_id"
                                                                    value="{{ old('location_id',@$user->candidate->location_id) ?? Request::query('location_id') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                @else
                                                    <div class="">
                                                        <select name="location_id" class="form-control">
                                                            <option selected disabled value="">{{ __('-- Please Select --') }}</option>
                                                            @php
                                                                $candidate = $user->candidate;
                                                                $traverse = function ($locations, $prefix = '') use (&$traverse, $candidate) {
                                                                    foreach ($locations as $location) {
                                                                        $selected = '';
                                                                        if (old('location_id',@$candidate->location_id) == $location->id) {
                                                                            $selected = 'selected';
                                                                        }
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="education_level" name="education_level">
                                                <option disabled value="" @if (old('education_level', @$user->candidate->education_level) == '') selected @endif>
                                                    {{ __('Select') }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="job_type_id" id="job_type_id" class="form-control">
                                                <option disabled value="">{{__(" Select Job Type")}}</option>
                                                @php
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" {{ old('relocate',$user->candidate?->relocate) === 'Yes' ? 'checked' : '' }} type="radio" name="relocate" id="relocateyes" value="Yes">
                                                <label class="form-check-label" for="relocateyes">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" {{ old('relocate',$user->candidate?->relocate) === 'No' ? 'checked' : '' }} type="radio" name="relocate" id="relocateno" value="No">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="work_type" id="work_type" class="form-control">
                                                <option disabled value="">{{__(" Select Work Type")}}</option>
                                                <option {{ old('work_type',$user->candidate?->work_type) === 'Remote' ? 'selected' : ''}} value="Remote">Remote</option>
                                                <option {{ old('work_type',$user->candidate?->work_type) === 'In-office' ? 'selected' : ''}} value="In-office">In-Office</option>
                                                <option {{ old('work_type',$user->candidate?->work_type) === 'Hybrid' ? 'selected' : ''}} value="Hybrid">Hybrid</option>
                                            </select>
                                        </div>
                                    </div>
...
@section('footer')
    ...
    <script>
        ...
        const iti = window.intlTelInput(phone, {
            nationalMode: false,
            initialCountry: "in",
            onlyCountries: ["in", "bh", "kw", "om", "qa", "sa", "ae"],
            utilsScript: "https://cdn.jsdelivr.net/npm/intl-tel-input@18.1.1/build/js/utils.js",
        });

        const reset = () => {
            errorMsg.innerHTML = "";
            if(errorMsg.classList.contains("text-success")) {
        ...
        phone.addEventListener('blur', () => {
            ...
            if (phone.value.trim()) {
                ...
                if (iti.isValidNumber()) {
                    ...
                    errorMsg.innerHTML = "* Valid Number";
