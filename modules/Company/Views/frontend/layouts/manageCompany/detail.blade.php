                            ...
                            <div class="widget-content">
                                <div class="row">
                                    ...
                                    @if (is_default_lang())
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input @if (old('allow_search',$row->allow_search)) checked @endif type="checkbox"
                                                    name="allow_search" id="allow_search" value="1" class="form-control">
                                                <label for="allow_search">{{ __('Allow In Search & Listing') }}</label>
                                            </div>
                                        </div>
                                    @endif
